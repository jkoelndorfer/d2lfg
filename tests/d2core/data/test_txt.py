...
class TestDiablo2TxtRecord:
    ...
    def test_getitem_int_returns_correct_value(
        ...
        """
        Verifies that :py:meth:`~d2lfg.d2core.data.txt.Diablo2TxtRecord.__getitem__`
        returns the correct value when the key is an integer.
        """
    ...
    def test_getitem_string_returns_correct_value(
        ...
        """
        Verifies that :py:meth:`~d2lfg.d2core.data.txt.Diablo2TxtRecord.__getitem__`
        returns the correct value when the key is a string.
        """
        assert axe_txt_record[key] == expected_value

    def test_len_returns_correct_len(self, axe_txt_record: Diablo2TxtRecord) -> None:
        """
        Verifies that :py:meth:`~d2lfg.d2core.data.txt.Diablo2TxtRecord.__len__`
    ...
    def test_repr_returns_string(self, axe_txt_record: Diablo2TxtRecord) -> None:
        """
        Verifies that :py:meth:`~d2lfg.d2core.data.txt.Diablo2TxtRecord.__repr__`
        returns a string
        """
